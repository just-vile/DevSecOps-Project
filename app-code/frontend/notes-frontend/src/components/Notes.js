...
const Notes = () => {
    ...
    const fetchNotes = async () => {
        const response = await axios.get('k8s-threetie-backendi-89d961f034-153311098.us-east-1.elb.amazonaws.com/api/notes/');
        setNotes(response.data);
    };

    const addNote = async () => {
        const response = await axios.post('k8s-threetie-backendi-89d961f034-153311098.us-east-1.elb.amazonaws.com/api/notes/', { title, content });
