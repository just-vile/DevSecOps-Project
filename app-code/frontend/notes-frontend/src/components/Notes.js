...
const Notes = () => {
    ...
    const fetchNotes = async () => {
        const response = await axios.get('http://k8s-threetie-backendi-89d961f034-150712390.us-east-1.elb.amazonaws.com/api/notes/');
        setNotes(response.data);
    };

    const addNote = async () => {
        const response = await axios.post('http://k8s-threetie-backendi-89d961f034-150712390.us-east-1.elb.amazonaws.com/api/notes/', { title, content });
